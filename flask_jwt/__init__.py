...
def _get_serializer():
    ...
    if isinstance(expires_in, timedelta):
        try:
                ...
                # Source: http://stackoverflow.com/questions/28089558/alternative-to-total-seconds-in-python-2-6
                expires_in = int((expires_in.microseconds + 0.0 + (expires_in.seconds + expires_in.days * 24 * 3600) * 10 ** 6) / 10 ** 6)
